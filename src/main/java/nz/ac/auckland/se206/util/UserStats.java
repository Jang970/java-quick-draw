...
/**
 * This class will handle all functionalities relating to a user profile's stats.
 * An object of this class will be returned by UserManager method: getUserStats
 */
